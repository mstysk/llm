...
export type ComponentPropsWithoutRef<T extends JSX.ElementType> =
  PropsWithoutRef<ComponentProps<T>>;

export type PrimitivePropsWithRef<E extends JSX.ElementType> =
...
export type ComponentPropsWithRef<T extends JSX.ElementType> = T extends
